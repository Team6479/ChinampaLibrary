...
/**
 * This class is a thin wrapper around the {@link TalonSRX} that reduces CAN bus / CPU overhead by
 * skipping duplicate set commands. (By default the Talon flushes the Tx buffer on every set call).
 */

...
public class TeleopMechanumDrive extends CommandBase {
  ...
  public TeleopMechanumDrive(MecanumDrive drivetrain, DoubleSupplier speedLR,
                             DoubleSupplier rotation, DoubleSupplier speedFB) {
  ...
  @Override
  public void execute() {
    drivetrain.mecanumDrive(speedLR.getAsDouble(), rotation.getAsDouble(),
                            speedFB.getAsDouble());
  }

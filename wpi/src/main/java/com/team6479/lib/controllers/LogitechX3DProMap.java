...
/**
 * The LogitechX3DProMap holds all of the ports for the buttons, triggers, and stick. These integers
 * can be accesed through the OI to make a joystick object. Use this class to remove magic numbers.
 *
 * @author Aiden Onstott
 */
public class LogitechX3DProMap {
